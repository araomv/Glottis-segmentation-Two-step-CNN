...
VGG_Weights_path = file_path+"/../weights/vgg16_weights_tf_dim_ordering_tf_kernels.h5"

def seg4( n_classes ,  input_height=416, input_width=608 , vgg_level=3):
	...
	o = (UpSampling2D((2,2),data_format='channels_last'))(o)                            # removed me 
	...
	x1 = Flatten(name="flat",data_format='channels_last')(o)
